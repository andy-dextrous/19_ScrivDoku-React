		...
		return (
			<svg
				...
				<g fill="none" fillRule="evenodd">
					<path
						fill="#0072E3"
						d="M9.71 2.864c.374.346.425.911.136 1.316l-.08.097L7.62 6.603l3.412.018c5.522 0 10 4.478 10 10 0 5.523-4.478 10-10 10-5.523 0-10-4.477-10-10 0-.552.447-1 1-1 .552 0 1 .448 1 1 0 4.419 3.581 8 8 8 4.418 0 8-3.581 8-8 0-4.335-3.448-7.864-7.756-7.996l-.25-.004-3.476-.018 2.276 2.526c.341.379.34.947.014 1.323l-.088.09c-.379.34-.947.339-1.322.014l-.09-.088L4.578 8.29c-.317-.352-.34-.872-.072-1.249l.08-.099 3.71-4.022c.375-.406 1.008-.432 1.414-.057z"
						transform="translate(4 -.4)"></path>
					<path
						fill="#D8D8D8"
						d="M8.55 0L1.347 8l7.201-8z"
						transform="matrix(0 1 1 0 5 -1.3)"></path>
				</g>
			</svg>
		)
	}
