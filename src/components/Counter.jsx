...
import { boardContext, pausedContext } from "../App"
import { FaPause } from "react-icons/fa"
import { FaPlay } from "react-icons/fa"

const Counter = () => {
	const { boardConfig, difficulty } = useContext(boardContext)
	const { setIsPaused, isPaused } = useContext(pausedContext)
	...
	return (
		<div className="count" id="count">
			<div id="timer" className="timerDisplay">
				{!isPaused ? timer : pausedValue.current}
				{!isPaused ? (
